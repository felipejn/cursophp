...
class Documento {
    ...
    public static function validarCPF($cpf):bool { // Validar CPF
...
/*
$cpf = new Documento(); // Chamando método Documento
$cpf -> setNumero("14628556016");

var_dump($cpf->getNumero());
*/

var_dump(Documento::validarCPF("14628556016")); // Chamando método estatico
