...
class Usuario {
    ...
    // Carrega dados de um usuario pelo ID
    ...
    public static function getList() { // Método estático por não usar $this
        $sql = new Sql();
